...
// setStringForModule is a host function that allows a string to be written to
// another modules memory. This is reuqired when calling external functions in modules
// that require complex types. At present shared module memory is not available in Wasm,
// this may change in the future.
//
//export set_string_for_module
func setStringForModule(stringToSet WasmString, moduleName WasmString) WasmString
